...
const page = () => {
  return (
    <main>
      <Hero 
      subtitle="PENDIRIAN PERSEKUTUAN PERDATA"
      backgroundImage="/hero.png" 
      title={["Bisnis Berpihak", "pada Keadilan", "bersama", "Persekutuan Perdata"]} 
      description='Pendirian Persekutuan Perdata memberikan perlindungan hukum bagi anggotanya dalam menjalankan kegiatan bisnis bersama-sama. Dengan kesepakatan yang jelas dan dukungan hukum, Persekutuan Perdata memberikan keamanan dan kenyamanan bagi para anggotanya.'/>
    
    <section className="max-w-5xl mx-auto mt-8">
          <div className="container">
            <div className='mb-8'>
              <p className='text-2xl mb-4'>Persekutuan perdata memiliki beberapa manfaat, antara lain:</p>
              <ul className='list-decimal pl-5 space-y-2'>
                <li>Sumber daya yang lebih banyak</li>
                <li>Keahlian yang beragam</li>
                <li>Tanggung jawab bersama</li>
                <li>Keuntungan yang lebih besar</li>
                <li>Fleksibilitas</li>
                <li>Kemitraan strategis</li>
                <li>Keuntungan pajak</li>
              </ul>
            </div>
